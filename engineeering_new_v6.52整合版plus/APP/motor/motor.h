...
#define CAN_3508Motor12_ID     0x203  	//同步带
#define CAN_3508Motor13_ID     0x204		//同步带
#define CAN_2006Motor9_ID      0x205  	//救援卡
...
void stop_handel_motor(void);		//将机械臂位置固定在当前值
void set_gimbal_current(void); //设置云台电流 2020.7.24
void set_flip_current(void);	//设置翻转装置电机电流
